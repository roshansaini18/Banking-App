...
import { DeleteOutlined, EditOutlined, EyeInvisibleOutlined, EyeInvisibleTwoTone, EyeOutlined, SearchOutlined } from "@ant-design/icons";
...
const NewEmployee = () => {
  ...
  // get branch data
  const {data:branches,error:bError}=useSWR("/api/branch",
    fetchData,
    {
